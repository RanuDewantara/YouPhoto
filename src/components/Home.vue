<template>
	<div class="bg-[url('/src/assets/img/cameraman.jpg')] bg-blend-difference bg-cover bg-no-repeat bg-[-28rem] h-screen pt-[20%] md:bg-center">
		<div class="max-w-7xl px-5 py-32 mx-auto font-['Orbitron'] text-white items-center md:px-22 md:py-12">
			<h3 class="font-semibold text- text-xl">Welcome to</h3>
			<h1 class="font-bold text-5xl text-white"><span class="text-sky-600">You</span>Photo</h1>
